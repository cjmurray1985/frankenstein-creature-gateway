...
Purple contour laboratory pass (2026-09-21): the settled laboratory exposure is darker and no longer adds green light to the Creature's already green scan. A low violet side key (0.82) and purple rear rim (0.26) trace the brow, nose, cheek and jaw; ambient falls to 0.010 and neutral frontal fill to 0.12. The intermittent green lamp is replaced by a restrained purple spark with a weaker blue counterpart, and the entry flash background tint is violet rather than green. Linear sclera color rises slightly to (0.18, 0.18, 0.17). A tiny eye-only luminance floor (approximately 0.014 on the sclera and a texture-derived 0.32 multiplier on the iris) keeps both eyes and their pupil contrast legible inside the deep orbital shadows without appearing self-lit. Geometry, pupil targeting, eyelid pose and lighting timing are unchanged.
