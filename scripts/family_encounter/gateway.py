...
<main><h1>Enter the laboratory</h1><p role="status">{message}</p><form method="post" action="/login"><label for="password">Family password</label><input id="password" name="password" type="password" autocomplete="current-password" required maxlength="128"><button>Enter</button></form></main><script>
